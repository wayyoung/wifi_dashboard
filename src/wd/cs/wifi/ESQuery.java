...
//type 0 hmac / docId
//type 1 docId / object
//type 2 hmac+mac / object
public class ESQuery {
    public TreeMap<String,Object>  queryDevices(int type)throws Exception{
        ...
        try{
            ...
            searchRequest.types(ELK.TYPE_KAMINO_DEVICE);
...
//                    System.out.println(mac+","+hmac);
                    if(type==2) {
                        ...
                        res.put(hmac,(String)sourceAsMap.get("_id"));
                    }
                    x++;
...
//    public TreeMap<String,Object>  queryDiconnectionAgainstBuild(int type)throws Exception{
//        TreeMap<String,Object> res=new TreeMap<String,Object>();
//        RestHighLevelClient client = new RestHighLevelClient(
//                RestClient.builder(
//                        new HttpHost(ELK.SERVER_IP, ELK.ES_PORT, "http"),
...
//
//            SearchRequest searchRequest = new SearchRequest(ELK.INDEX_NAME);
//            searchRequest.types(ELK.TYPE_DISCONECTION_AGAINST_BUILD);
//            SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder();
//            searchSourceBuilder.size(10);
//            searchSourceBuilder.query(QueryBuilders.matchAllQuery());
//
...
//    }
    ...
    public TreeMap<String,Object> queryDevices()throws Exception{
        return this.queryDevices(2);
    }
